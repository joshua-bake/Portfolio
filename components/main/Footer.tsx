            ...
            <div className="w-full flex flex-col items-center justify-center m-auto">
                <div className="w-full h-full flex flex-row items center justify-around flex-wrap">
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                        <a target="_blank" href={TO_GITHUB} rel="noopener noreferrer" className='flex text-white flex-row items-center my-[15px] '><RxGithubLogo /><span className='text-[15px] ml-[6px]'>GitHub</span></a>
                    </div>
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                    ...
                    <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
                        <a target="_blank" href={TO_LINKEDIN} rel="noopener noreferrer" className='flex text-white flex-row items-center my-[15px] '><RxLinkedinLogo /><span className='text-[15px] ml-[6px]'>LinkedIn</span></a>
                    </div>
                </div>
